...
# def save_chat_message(pk: str, timestamp: str, message: str, emotion: str, keywords: list):
#     key = f"chat:{pk}"
#     data = {
#         "userId": pk,
#         "timestamp": timestamp,
