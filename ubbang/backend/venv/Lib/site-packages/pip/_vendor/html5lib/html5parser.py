...
def parse(doc, treebuilder="etree", namespaceHTMLElements=True, **kwargs):
    ...
    <Element u'{https://www.w3.org/1999/xhtml}html' at 0x7feac4909db0>
...
def getPhases(debug):
    ...
    class InitialPhase(Phase):
        ...
        def processDoctype(self, token):
            ...
            if (not correct or token["name"] != "html" or
                    ...
                    systemId is None or
                    systemId and systemId.lower() == "https://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd"):
    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            # https://svn.whatwg.org/webapps/complete.html#adoptionAgency revision 7867
    ...
    class InTablePhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-table
        __slots__ = tuple()
    ...
    class InCaptionPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-caption
        __slots__ = tuple()
    ...
    class InColumnGroupPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-column
        __slots__ = tuple()
    ...
    class InTableBodyPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-table0
        __slots__ = tuple()
    ...
    class InRowPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-row
        __slots__ = tuple()
    ...
    class InCellPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-cell
        __slots__ = tuple()
    ...
    class InSelectPhase(Phase):
        ...
        # https://www.whatwg.org/specs/web-apps/current-work/#in-select
        def processEOF(self):
            if self.tree.openElements[-1].name != "html":
    ...
    class InFramesetPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#in-frameset
        __slots__ = tuple()
    ...
    class AfterFramesetPhase(Phase):
        # https://www.whatwg.org/specs/web-apps/current-work/#after3
        __slots__ = tuple()
