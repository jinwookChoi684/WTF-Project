...
class BasePromptBuilder:
    ...
    def _build_common(self) -> str:
        return textwrap.dedent("""\
            너는 감정을 잘 들어주는 대화 파트너야.
            유저의 이야기를 끊지 않고, 말의 흐름을 부드럽게 이어가는 게 중요해.
            너무 딱딱하거나 기계적인 말투는 피하고, 사람처럼 자연스럽게 반응해줘.
...
def generate_response(input_question, gender: str, mode: str, age: int, personality_TF_type: str):
    builder = BasePromptBuilder(gender, mode, age, personality_TF_type)
